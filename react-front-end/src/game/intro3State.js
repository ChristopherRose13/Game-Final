...
class SceneMain extends Phaser.Scene {
  constructor() {
                  ...
                  this.moveXLeft = this.moveXLeft.bind(this);
                  this.moveXRight = this.moveXRight.bind(this);
                  this.moveXNeutral = this.moveXNeutral.bind(this);
                  this.moveYUp = this.moveYUp.bind(this);
                  this.moveYDown = this.moveYDown.bind(this);
                  this.moveYNeutral = this.moveYNeutral.bind(this);
                }
moveXLeft () {
  this.setState({ movementX: "left"});
}
moveXRight () {
  this.setState({ movementX: "left"});
}
moveXNeutral () {
  this.setState({ movementX: "neutral"});
}
moveYUp () {
  this.setState({ movementY: "up"});
}
moveYDown () {
  this.setState({ movementY: "down"});
}
moveYNeutral () {
  this.setState({ movementY: "neutral"});
}
componentDidMount() {
  this.updateFunction();
  if (annyang) {
